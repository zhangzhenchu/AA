...
namespace RSERP
{
    public class ComprehensiveStock
    {
        ...
        {
            return ComprehensiveStockInfo(iLoginEx, cType, cInvCode, cDateL, cDateH, UFsystem, cWhCode, iKeys, "", 1);
        }
        ...
        /// <returns></returns>
        public string ComprehensiveStockInfo(LoginEx iLoginEx, ushort cType, string cInvCode, string cDateL, string cDateH, string UFsystem, string cWhCode, string iKeys, string tempTableName, ushort CurSotckQtySource)
        {
            ...
            string selectSQL = "";
            selectSQL = " if exists (select 1  from tempdb.dbo.sysobjects where upper(name)= upper('" + tempTableName + "') and type='U')   \r\n";
            ...
            //selectSQL += "  ForecastQty  decimal(28,4) null default 0,    \r\n";
